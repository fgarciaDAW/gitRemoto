...
public class Ejercicio10 {
    ...
    public static void menu(){
        ...
        do {
            ...
            System.out.println("1.-Añadir numero de tipo double al principio del fichero");
    ...
    public static void crearFichero() {
        ...
        try {
            File fichero = new File("ficheros/fichero.obj");
            raf = new RandomAccessFile(fichero, "rw");
            addNumenosAlPrincipio(raf);
        } catch (Exception e) {
    ...
    public static void addNumenosAlPrincipio(RandomAccessFile raf) throws Exception {
        Scanner teclado = new Scanner(System.in);
        double numero;
    ...
    public static void addNumenosAlFinal(RandomAccessFile raf) throws Exception {
        Scanner teclado = new Scanner(System.in);
        double numero;
